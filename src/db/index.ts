...
// WAL allows concurrent reads while the single process-wide write queue
// serializes writes on this same connection. Keep a generous busy timeout for
// maintenance operations such as retention and schema upgrades.
sqlite.exec(`PRAGMA busy_timeout = ${config.sqliteBusyTimeoutMs};`);
